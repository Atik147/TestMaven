package com.qa.testNg;
	...
	public class FacebookTest {
			...
			//Go to https://www.facebook.com , pass ~!@#*& in the email field
				//and hit enter. From the landing page capture the following items:
				//a) Title
				//b) Url
				//c) Value of the email field
				//d) Texts (two texts in two different lines) of the error message
				//e) Background-color value of the error message (which comes in light
				//red shed)
				//Add soft assertions for all the extracted values
				//## Note that for asserting background color, you need to convert the
				//hexadecimal color code (extracted from the Styles tab of dev tools for
				//the web element) to RGBA value. You can do the conversion using the
				//following website Hex to RGBA (rgbacolorpicker.com)
		...
		public void facebookTest() throws InterruptedException {
			...
			//String expectedMessaage = "The email or mobile number you entered isn't connected to an account. Find your account and log in.";
